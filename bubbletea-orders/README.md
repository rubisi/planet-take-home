...
## AI Assistance
I used ChatGPT as a helper tool for two specific tasks during development (mainly for syntax clarification and refinement and not for generating the full solution)
